-- Script para corregir la precisión de decimales en la vista vStockDisponible
-- Este script preserva la precisión completa de los decimales en el cálculo de Disponible
