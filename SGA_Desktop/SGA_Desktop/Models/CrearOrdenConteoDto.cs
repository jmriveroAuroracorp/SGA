...
{
    public class CrearOrdenConteoDto
    {
        ...
        public string? Visibilidad { get; set; } = "VISIBLE";
        ...
        public string? ModoGeneracion { get; set; } = "AUTOMATICO";
        
        [StringLength(20, ErrorMessage = "El alcance no puede exceder 20 caracteres")]
        public string? Alcance { get; set; } = "ALMACEN";
